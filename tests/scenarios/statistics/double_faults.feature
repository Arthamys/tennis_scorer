Feature: Double Fault Statistics
  ...
  Scenario: Single double fault is recorded
    ...
    And player 1 should have 0 first serves in out of 1 total
    And player 1 first serve percentage should be 0%
    And player 1 should have 0 second serves in out of 1 total
    And player 1 second serve percentage should be 0%
  ...
  Scenario: Multiple double faults are accumulated
    ...
    And player 1 should have 0 first serves in out of 2 total
    And player 1 first serve percentage should be 0%
    And player 1 should have 0 second serves in out of 2 total
    And player 1 second serve percentage should be 0%
    And player 2 should have 0 double faults
  ...
  Scenario: Double fault affects serve totals
    ...
    Then player 1 should have 0 first serves in out of 1 total
    And player 1 first serve percentage should be 0%
    Then player 1 should have 0 second serves in out of 1 total
    And player 1 second serve percentage should be 0%
